<template>
  ...
  <!-- 分頁 -->
  <pagination :pages="pagination" @checkpage="getProducts"></pagination>
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                v-model="tempProduct.is_enabled" :true="1" :false="0"
                  id="is_enabled">
...
<div class="modal fade" id="delProductModal" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
        <button type="button" class="btn btn-danger" @click="delectProduct">確認刪除</button>
      </div>
    </div>
  </div>
</div>
  ...
  methods: {
    ...
    openModal(isNew,item){
      if(isNew){
        ...
        this.tempProduct = Object.assign({},item); //因物件參考特性 用Object.assign 複製原物件
        this.isNew = false;
      }
